...
online_softmax, masked_softmax, sum, rope_cos, int8_add, and hll_register
against an independent high-precision (decimal.Decimal) reference on
adversarial fixtures, at float16/float32/float64 precision (int8_add and
