...
weight_decay, gradient_accumulation_bias, longrope_factor_select, and
squared_euclidean_distance against an independent high-precision
(decimal.Decimal) reference on adversarial fixtures, at
float16/float32/float64 precision (int8_add and
